...
const TemplateItem = ({
  ...
  return isMobile ? (
    <TemplateItemMobileView
      ...
      userId={userId}
      options={options}
      isActiveEditForm={isSetRenamingTemplateId}
      handleUpdateTemplate={handleUpdateTemplate}
    />
  ) : (
    <div
      className={classNames('table__row', 'table__dataRow document template', className)}
    >
      ...
      <div className="table__column table__column--text--document template">
        {isSetRenamingTemplateId ? (
      ...
      <div className="table__column table__column--template-date document">
