    ...
    <div className="documents__optionsDropdown" ref={containerRef}>
      ...
      {isOpen && (
        <div
          ...
          ref={dropdownListRef}
        >
          <div className="documents__dropdownOptionWrapper">
            <div className="documents__dropdownOptionSigners documents__dropdownOptionSigners--bold">
              <div className="documents__dropdownOptionSigners--name">Name</div>
              <span>Email</span>
            </div>
          </div>
          {signers.map(signer => (
            <div key={signer.id} className="documents__dropdownOptionWrapper">
              <div className="documents__dropdownOptionSigners">
                <div className="documents__dropdownOptionSigners--name">
                  {signer.name}
                </div>
