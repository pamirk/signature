...
const DayElement = ({
    ...
    // @ts-ignore
    const top = day.getDate() <= 7 || (day.getDate() - selectedRange?.from.getDate() <= 7 && currentMonth === selectedRange.from.getMonth());
    // @ts-ignore
    const bottom = day.getDate() + 7 > lastDay || (selectedRange?.to.getDate() - day.getDate() <= 7 && currentMonth === selectedRange.to.getMonth());
